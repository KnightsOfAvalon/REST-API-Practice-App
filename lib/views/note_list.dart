...
import 'package:rest_api_project/services/notes.service.dart';
import 'package:rest_api_project/views/note_modify.dart';

import 'note.delete.dart';
      ...
      body: Builder(
        builder: (_) {
          ...
          return ListView.separated(
            separatorBuilder: (_, __) => Divider(height: 1, color: Colors.purple),
            itemBuilder: (_, index) {
              return Dismissible(
